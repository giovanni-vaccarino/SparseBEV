...
image_path = '../data/aida_mdp_500/samples/CAM_FRONT/2025-03-13_11-54_000007.png'

# === Load JSON Output ===
with open(output_json_path, 'r') as f:
    results = json.load(f)

sample_token = "2025-03-13_11-54_000007"
...
filter_bboxes = results[7]['scores_3d'] > 0.25


bboxes_3d_manual = results[7]['boxes_3d'][filter_bboxes]
labels_3d_manual = results[7]['labels_3d'][filter_bboxes].numpy()
